...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at https://gabrielforest.github.io/cv/")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/gabrielforest/cv/docs/cv.pdf)")
}
```

## Contact 

- <i class="fa fa-envelope"></i> [Email](gabrielfreitaspereira10@gmail.com)

- <i class="fa fa-phone"></i> +5515998260810

- <i class="fa fa-github"></i> [GitHub: `@`Gabrielforest](https://github.com/Gabrielforest)

- <i class="fa fa-home"></i>[Portfolio](https://gabrielforest.github.io/portfolio/)
